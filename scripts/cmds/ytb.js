...
module.exports = {
	config: {
		...
		longDescription: {
			...
			en: "تحميل الفيديو أو الصوت، أو عرض معلومات الفيديو على يوتيوب."
		},
		category: "media",
		guide: {
			vi: "   {pn} [video|-v] [<tên video>|<link video>]: dùng để tải video từ youtube."
				...
				+ "\n    {pn} -a Fallen Kingdom"
				+ "\n    {pn} -i Fallen Kingdom",
			en:"{pn} [فيديو|-v] [<اسم الفيديو>|<رابط الفيديو>]: لتنزيل الفيديو من يوتيوب."
				+ "\n   {pn} [صوت|-a] [<اسم الفيديو>|<رابط الفيديو>]: لتنزيل الصوت من يوتيوب."
	...
	langs: {
		...
		en: {
			error: "❌ حدث خطأ: %1",
			noResult: "⭕ لا توجد نتائج بحث تتطابق مع الكلمة الأساسية %1",
			choose: "%1 الرجاء الرد على الرسالة برقم للاختيار أو أي محتوى للإلغاء",
			video: "فيديو",
			audio: "صوت",
			downloading: "⬇️ تنزيل %1 \"%2\"",
			downloading2: "⬇️ تنزيل %1 \"%2\"\n🔃 السرعة: %3MB/s\n⏸️ تم تنزيل: %4/%5MB (%6%)\n⏳ الوقت المتبقي المقدر: %7 ثانية",
