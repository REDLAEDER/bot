module.exports = {
	config: {
		...
		guide: {
			...
			en: "   {pn}: يستخدم لعرض عدد رسائلك"
+ "\n {pn} @tag: يستخدم لعرض عدد رسائل الأشخاص المعنيين بالتاغ"
+ "\n {pn} all: يستخدم لعرض عدد رسائل جميع الأعضاء"
	...
	langs: {
		...
		en: {
			...
			endMessage: "الأشخاص الذين لا يوجد لديهم اسم في القائمة لم يقموا بإرسال أي رسائل.",
			page: "الصفحة [%1/%2]",
			reply: "يرجى الرد على هذه الرسالة مع رقم الصفحة لعرض المزيد",
			result: "%1 يحتل المركز %2 بـ %3 رسالة",
			yourResult: "أنت تحتل المركز %1 ولقد قمت بإرسال %2 رسالة في هذه المجموعة",
