...
module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "تحميل فيدو من فيسبوك"
		},
		longDescription: {
			vi: "Tải video/story từ facebook (công khai)",
			en: "تحميل فيديو/قصة او ريلز من فيسبوك (عامة))"
		},
		category: "media",
		guide: {
			en: "   {pn} <url video/story>: تحميل فيديو/قصة ريلز من فيسبوك"
		}
	},
	...
	langs: {
		...
		en: {
			missingUrl: "يرجى إدخال رابط الفيديو / القصة العامة على فيسبوك الذي تريد تنزيله",
			error: "حدث خطأ أثناء تنزيل الفيديو",
			downloading: "جارٍ تحميل الفيديو لك",
			tooLarge: "عذرًا ، لا يمكننا تنزيل الفيديو بالنسبة لك لأن حجمه أكبر من 83 ميجا بايت"
		}
	},
