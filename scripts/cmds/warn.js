...
module.exports = {
	config: {
		...
		longDescription: {
			...
			en: "تحذير الأعضاء في المجموعة، إذا كان لديهم 3 تحذيرات، فسيتم حظرهم."
		},
		category: "box chat",
		guide: {
			...
			en: "   {pn} @tag <reason>: اخطر عضو"
				+ "\n   {pn} list: عرض قائمة الأعضاء المحذرين"
				+ "\n   {pn} listban: عرض قائمة الأعضاء المحظورين"
				+ "\n   {pn} info [@tag | <uid> | اتركه فارغًا]: عرض معلومات التحذير لعضو معين بالاشارة او بـ uid او لنفسك"
				+ "\n   {pn} unban <uid>: الغاء حظر العضو باستخدام الـ uid"
				+ "\n   {pn} unwarn <uid> [<warn number> | اتركه فارغًا]: الغاء تحذير عضو باستخدام الـ uid ورقم التحذير"
				+ "\n   {pn} warn reset: اعادة ضبط كل بيانات التحذير"
				+ "\n⚠️ يجب تعيين الصلاحية الإدارية للبوت للطرد التلقائي للأعضاء المحظورين"
		}
	},
	...
	langs: {
		...
		en: {
			list: "قائمة الأعضاء الذين تم تحذيرهم: \ n٪1  \ n \ n لعرض تفاصيل التحذيرات ، استخدم الأمر \ ٪2 انذار info [tag | <uid> | اترك فارغًا] \": لعرض معلومات التحذير الشخص الذي تم وضع علامة عليه أو uid أو لنفسك",
			listBan: "قائمة الأعضاء الذين تم تحذيرهم 3 مرات ومنعهم من دخول المجموعة،:\n%1",
			listEmpty: "مجموعتك ليس لديها أعضاء تم تحذيرهم",
			listBanEmpty: "مجموعتك ليس لديها أعضاء ممنوعون من المربع",
			invalidUid: "الرجاء إدخال معرف صالح للشخص الذي تريد عرض المعلومات",
			noData: "لايوجد بيانات",
			noPermission: "❌ يمكن فقط لمسؤولي المجموعة إلغاء حظر الأعضاء المحظورين من المجموعة",
			invalidUid2: "⚠️ الرجاء إدخال معرف صالح للشخص الذي تريد إلغاء حظره",
			notBanned: "⚠️ لم يتم حظر المستخدم بالمعرف ٪1 من المجموعة الخاص بك",
			unbanSuccess: "✅ تم الغاءالحظر بنجاح [٪1 | ٪2] ، يمكن لهذا الشخص حاليًا الانضمام إلى المجموعة  الخاص بك",
			noPermission2: "❌ Only group administrators can remove warnings from members in the group",
			invalidUid3: "⚠️ الرجاء إدخال uid أو وضع علامة على الشخص الذي تريد إزالة التحذير",
