...
module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "تصفيه اعضاء ميتين"
		},
		longDescription: {
			vi: "lọc thành viên nhóm theo số tin nhắn hoặc bị khóa acc",
			en: "تصفيه عن طريق عدد رسايل( انت تحدد عدد) او تصفيه حسابات مغلقه"
		},
		category: "box chat",
		guide: {
	...
	langs: {
		...
		en: {
			needAdmin: "⚠️ | لاستخدام هذا الأمر، يرجى إضافة البوت كمسؤول للمجموعة",
			confirm: "⚠️ | هل أنت متأكد من رغبتك في حذف أعضاء المجموعة الذين لديهم أقل من %1 رسالة؟\nيرجى الرد على هذه الرسالة للتأكيد",
			kickByBlock: "✅ | تمت إزالة %1 أعضاء بحسابات غير متاحة بنجاح",
			kickByMsg: "✅ | تمت إزالة %1 أعضاء بأقل من %2 رسالة بنجاح",
			kickError: "❌ | حدث خطأ ولم يتمكن من حذف %1 أعضاء:\n%2",
			noBlock: "✅ | لا يوجد أعضاء لديهم حسابات غير متاحة",
