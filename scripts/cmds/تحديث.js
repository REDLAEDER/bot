...
module.exports = {
	config: {
		...
		role: 2,
		shortDescription: {
			en: "التحقق من وتثبيت التحديثات للبوت.",
	...
	langs: {
		...
		en: {
			...
			updatePrompt: "أنت تستخدم الإصدار %1. هناك إصدار جديد %2. هل تريد تحديث بوت الدردشة إلى أحدث إصدار؟\n\nسيتم تحديث الملفات التالية:\n%3%4\n\n \nيرجى الرد على هذه الرسالة لتأكيد الإجراء.",
			fileWillDelete: "\nسيتم حذف الملفات / المجلدات التالية:\n%1",
			andMore: " - ... و %1 ملفات أخرى",
			updateConfirmed: "تم تأكيد التحديث ، جاري التحديث...",
			updateComplete: "تم التحديث! سيتم إعادة تشغيل الروبوت الدردشة لتطبيق التغييرات."
		}
	},
	...
	onLoad: async function ({ api }) {
		if (fs.existsSync(dirBootLogTemp)) {
			...
			api.sendMessage("تم اعاده تشغيل.", threadID);
		}
	},
