module.exports = {
  config: {
    ...
    category: "owner",
    guide: {
      en: "{pn} <thread | user | dashboard | global | group>"
    }
  },
  ...
  langs: {
    vi: {
      ...
      successGroup: "✅ Đã đồng bộ dữ liệu nhóm từ json sang mongodb thành công!"
    },
    en: {
      ...
      successGroup: "✅ Successfully synchronized group data from json to mongodb!"
    }
  },

  onStart: async function ({ args, message, threadModel, userModel, dashBoardModel, globalModel, groupModel, getLang }) {
    switch (args[0]) {
      case "thread": {
        let oldThreadsData;
        try {
