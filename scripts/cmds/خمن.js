...
module.exports = {
	config: {
		...
		guide: {
			...
			en: "{pn} [4 | 5 | 6] [single | multi]: إنشاء لعبة جديدة، مع:"
+"\n 4 5 6 هو عدد الأرقام في الرقم الذي يجب تخمينه، والافتراضي هو 4."
+"\n single | multi هو وضع اللعبة، single هو لاعب واحد، multi هو لاعبون متعددون، والافتراضي هو single."
+"\n   مثال:"
+"\n    {pn}"
+"\n    {pn} 4 single"
+"\n\n كيفية اللعب: يقوم اللاعب بالرد على رسالة البوت باتباع القواعد التالية:"
+"\n لديك 10 محاولات (4 أرقام)، 12 محاولة (5 أرقام)، 15 محاولة (6 أرقام)."
+"\n بعد كل محاولة، ستحصل على تلميحات إضافية عن عدد الأرقام الصحيحة (الموجودة على اليسار) وعدد الأرقام الصحيحة (الموجودة على اليمين)."
+"\n ملاحظة: يتم تشكيل الرقم من الأرقام من 0 إلى 9، ويظهر كل رقم مرة واحدة ويمكن أن يبدأ الرقم بالصفر."
+"\n\n {pn} rank <page>: عرض الترتيب."
+"\n   {pn} info [<uid> | <@tag> | <reply> | <empty>]: عرض معلومات الترتيب الخاصة بك أو بأحد الآخرين."
+"\n   {pn} reset: إعادة تعيين الترتيب (فقط لمسؤول البوت)."
		}
	},
	...
	langs: {
		...
		en: {
			charts: "🏆 | الترتيب:\n%1",
			pageInfo: "الصفحة %1/%2",
			noScore: "⭕ | لا يوجد أي لاعب حصل على نقاط حتى الآن.",
			noPermissionReset: "⚠️ | ليس لديك الصلاحية لإعادة تعيين الترتيب.",
			notFoundUser: "⚠️ | لم يتم العثور على المستخدم برقم معرف %1 في الترتيب.",
			userRankInfo: "🏆 | معلومات الترتيب:\nالاسم: %1\nالنقاط: %2\nعدد الألعاب: %3\nعدد الانتصارات: %4\n%5\nعدد الهزائم: %6\nنسبة الفوز: %7%\nإجمالي وقت اللعب: %8",
			digits: "%1 أرقام: %2",
			resetRankSuccess: "✅ | تم إعادة تعيين الترتيب بنجاح.",
			invalidCol: "⚠️ | يرجى إدخال عدد الأرقام المكونة من الرقم الذي يجب تخمينه وهو 4 أو 5 أو 6.",
			invalidMode: "⚠️ | يرجى إدخال نوع اللعبة وهو مفردة (single) أو متعددة (multi).",
			created: "✅ | تم إنشاء اللعبة بنجاح.",
			gameName: "لعبة تخمين الأرقام",
			gameGuide: "⏳ | كيفية اللعب:\nلديك %1 محاولات للتخمين.\nبعد كل تخمين، ستحصل على تلميحات إضافية حول عدد الأرقام الصحيحة (يتم عرضها على اليسار) وعدد الأرقام الصحيحة في الموضع الصحيح (يتم عرضها على اليمين).",
			gameNote: "📄 | ملاحظة:\nيتم تشكيل الرقم من خلال الأرقام من 0 إلى 9، ويظهر كل رقم مرة واحدة ويمكن أن يبدأ الرقم بالصفر.",
			replyToPlayGame: "🎮 | الرجاء الرد على الرسالة أدناه بصورة للأرقام التي تخمنها والتي تتكون من %1 رقم للعب اللعبة.",
			
			invalidNumbers: "⚠️ | الرجاء إدخال %1 أرقام تريد التخمين بها",
			win: "🎉 | تهانينا لقد تخمنت الرقم %1 بعد %2 محاولة وحصلت على %3 نقطة مكافأة.",
